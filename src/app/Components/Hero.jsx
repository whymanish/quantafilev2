  ...
  return (
    <div>
      ...
      <section class="relative flex items-center justify-center">
                <div class="relative items-center w-full px-5 py-12 mx-auto max-w-7xl lg:px-16 lg:py-24 md:px-12">
                  <div>
                    <div class="relative text-center">
                      <p class="mt-8 text-3xl font-extrabold tracking-tighter text-black md:text-6xl">
                        Click on a component <span class="md:block">to go to its code</span>
                      </p>
                  ...
                  <div class="relative items-center w-full py-12 pb-12 mx-auto mt-12 max-w-7xl">
                    <svg fill="none" viewBox="0 0 400 400" height="100%" width="100%" xmlns="http://www.w3.org/2000/svg" class="absolute -mt-24 blur-3xl">
                      ...
                      </defs></svg><img src='https://images.unsplash.com/photo-1504253492562-cbc4dc540fcb?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' class="relative object-cover h-[74vh] w-full rounded shadow-2xl lg:rounded-2xl" >
                    </img>
                  </div>
                </div>
              </section>
